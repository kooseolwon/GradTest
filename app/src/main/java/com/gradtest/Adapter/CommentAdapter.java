 ...
 */
    ...
    public class CommentAdapter extends RecyclerView.Adapter<com.gradtest.Adapter.CommentAdapter.MyViewholder> {
        private Activity activity;
        private ArrayList<ItemForm> datalist;

        @Override
        public com.gradtest.Adapter.CommentAdapter.MyViewholder onCreateViewHolder(ViewGroup parent, int viewType) {

            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_layout,parent,false);
            com.gradtest.Adapter.CommentAdapter.MyViewholder viewholder = new com.gradtest.Adapter.CommentAdapter.MyViewholder(view);
        ...
        @Override
        public void onBindViewHolder(com.gradtest.Adapter.CommentAdapter.MyViewholder holder, int position) {
...
//                    Log.v("kooseolwon",wrTxt);
        ...
        public CommentAdapter(Activity activity, ArrayList<ItemForm> datalist){
